...
#define BUFFER_CLI_SIZE BUFFER_SERV_SIZE+ALIAS_SIZE+TOLERANCE     // adding a tolerance    //TODO: verify if block ok when preprocessor inserts it, need maybe bloc or ()
